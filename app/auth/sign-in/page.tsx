  ...
  return (
    <div style={{ minHeight: "100vh", background: G.bg, color: G.accent, fontFamily: "'DM Sans',sans-serif", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: "20px" }}>
      ...
      <div style={{ marginBottom: 40, textAlign: "center" }}>
        ...
        <p style={{ color: "#6b6c85", fontFamily: "'DM Mono',monospace", fontSize: 13 }}>AI-powered TikTok content generator for Web3 creators</p>
      </div>
      <div style={{ maxWidth: 400, width: "100%" }}>
        <SignIn appearance={{ variables: { colorPrimary: G.accent, colorBackground: G.surface, colorBorder: G.border, colorText: "#e2e3f0", colorInputBackground: G.surface, colorInputBorder: G.border } }} />
      </div>
    </div>
  );
}
